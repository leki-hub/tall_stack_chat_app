<div
    x-data="{
        ...
        typingName: '',
        showTyping: false,
        soundDelete: new Howl({ src: ['/sounds/delete.mp3'] }),
        soundSent: new Howl({ src: ['/sounds/sent.mp3'] }),
        soundReceived: new Howl({ src: ['/sounds/receive.mp3'] }),
    ...
    "
    x-on:message-sent.window="messageSent()"
    x-on:message-received.window="messageReceived()"
>
    <!-- Chat Messages -->
    ...
    <!-- Message Input -->
    <form wire:submit.prevent="sendMessage" class="flex gap-2" x-on:submit="messageSent()">
        <input type="text"
        ...
        <button type="submit"
                class="bg-blue-500 text-red px-4 py-2 rounded hover:bg-blue-600 transition">
            Send
        </button>
    </form>
